  ...
  return (
    <div className="carousel w-full">
      <div id="slide1" className="carousel-item relative w-full h-[600px]">
        ...
        <div className="absolute flex h-full pl-8 p-5 md:pl-20 rounded-xl gap-4  items-center bg-gradient-to-r from-[#151515] to-[#15151500]">
          <div className="text-white w-full md:w-1/2 space-y-7">
            ...
            <div>
              <button className="btn bg-red-500 text-white border-none mr-5">
                Discover More
              </button>
